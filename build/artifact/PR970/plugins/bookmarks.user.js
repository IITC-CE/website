...
// @updateURL      https://iitc.app/build/artifact/PR970/plugins/bookmarks.meta.js
// @downloadURL    https://iitc.app/build/artifact/PR970/plugins/bookmarks.user.js
...
plugin_info.dateTimeVersion = '2026-09-23-075953';
...
\
\
/* an icon is left out to keep its own font, or the ligature is drawn as its name */\
#bookmarksBox *:not(iitc-icon){\
	display:block;\
	padding:0;\
	margin:0;\
	width:auto;\
...
#bookmarksBox .bookmarksRemoveFrom iitc-icon {\
	line-height:18px;\
}\
...
.portal-list-bookmark iitc-icon {\
	margin: -3px;\
	cursor:pointer;\
}\
#bkmrksTrigger {\
...
.bkmrksStar iitc-icon {\
	float:left;\
	margin: 0 0 0 2px;\
	display:inline-flex;\
	align-items:center;\
	justify-content:center;\
	min-width:var(--icon-target-size, 24px);\
	min-height:var(--icon-target-size, 24px);\
}\
.bkmrksStar iitc-icon, .portal-list-bookmark iitc-icon {\
	font-size:16px;\
}\
.bkmrksStar iitc-icon, .bkmrksStar.favorite:focus iitc-icon {\
	font-variation-settings:\'FILL\' 0;\
}\
.bkmrksStar:focus iitc-icon, .bkmrksStar.favorite iitc-icon, .portal-list-bookmark.favorite iitc-icon {\
	font-variation-settings:\'FILL\' 1;\
}\
body.icons-unavailable .bkmrksStar iitc-icon::before, body.icons-unavailable .portal-list-bookmark iitc-icon::before{\
	content:"\\2606";\
}\
body.icons-unavailable .bkmrksStar.favorite iitc-icon::before, body.icons-unavailable .portal-list-bookmark.favorite iitc-icon::before{\
	content:"\\2605";\
}\
