...
// @category       Layer
// @version        0.12.1.20230525.184337
...
// @updateURL      https://iitc.app/build/artifact/PR633/plugins/player-activity-tracker.meta.js
// @downloadURL    https://iitc.app/build/artifact/PR633/plugins/player-activity-tracker.user.js
...
window.plugin.playerTracker.processNewData = function(data) {
  ...
  $.each(data.result, function(ind, json) {
    ...
    if (!plrname || !lat || !lng || !id || skipThisMessage || ![window.TEAM_RES, window.TEAM_ENL].includes(window.teamStringToId(json[2].plext.team))) return true;
