...
// @category       Misc
// @version        1.2.0.20240224.073809
// @description    Hide info from intel which shouldn't leak to players of the other faction.
// @id             privacy-view
// @namespace      https://github.com/IITC-CE/ingress-intel-total-conversion
// @updateURL      https://iitc.app/build/artifact/PR707/plugins/privacy-view.meta.js
// @downloadURL    https://iitc.app/build/artifact/PR707/plugins/privacy-view.user.js
...
plugin_info.dateTimeVersion = '2024-02-24-073809';
...
privacyView.toggle = () => {
  ...
  if (window.isSmartphone()) {
    ...
    document.body.classList.toggle('privacy_active');
  } else {
    const active = document.body.classList.toggle('privacy_active');
    $('#privacytoggle').text(active ? 'Privacy active' : 'Privacy inactive');
    if (!active) {
      // refresh chat
