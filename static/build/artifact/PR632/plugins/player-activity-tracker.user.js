...
// @category       Layer
// @version        0.12.2.20231013.162905
...
// @updateURL      https://iitc.app/build/artifact/PR632/plugins/player-activity-tracker.meta.js
// @downloadURL    https://iitc.app/build/artifact/PR632/plugins/player-activity-tracker.user.js
...
plugin_info.dateTimeVersion = '2023-10-13-162905';
...
window.plugin.playerTracker.processNewData = function(data) {
  ...
  $.each(data.result, function(ind, json) {
    ...
    var plrname, lat, lng, name, address;
    ...
    if (!plrname || !lat || !lng || skipThisMessage || ![window.TEAM_RES, window.TEAM_ENL].includes(window.teamStringToId(json[2].plext.team))) {
      return true;
    }
