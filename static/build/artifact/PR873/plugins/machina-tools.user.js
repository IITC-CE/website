...
// @updateURL      https://iitc.app/build/artifact/PR873/plugins/machina-tools.meta.js
// @downloadURL    https://iitc.app/build/artifact/PR873/plugins/machina-tools.user.js
...
plugin_info.dateTimeVersion = '2025-10-07-115325';
...
machinaTools.refreshLinkLengths = function () {
  if (window.map.hasLayer(machinaTools.linkLengthsLayer)) {
    ...
    machinaTools._maxLinks = Object.values(window.links)
      .filter((l) => l.options.team === window.TEAM_MAC && window.map.getBounds().contains(new L.LatLng(l.options.data.oLatE6 / 1e6, l.options.data.oLngE6 / 1e6)))
