...
// @updateURL      https://iitc.app/build/artifact/PR620/plugins/sync.meta.js
// @downloadURL    https://iitc.app/build/artifact/PR620/plugins/sync.user.js
...
window.plugin.sync.Authorizer.prototype.updateSigninStatus = function(isSignedIn) {
  ...
  if (isSignedIn) {
    ...
    this.authorized = false;
    plugin.sync.logger.log('all', 'Not authorized');
